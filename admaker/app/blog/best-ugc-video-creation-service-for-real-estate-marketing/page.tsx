...
export const metadata: Metadata = {
    ...
    openGraph: {
        ...
        images: [{
            ...
            width: 1200,
            height: 630,
            alt: 'Real estate video creation dashboard'
        }]
    },
    twitter: {
                ...
                <article className={styles.articleContent}>
                    <header className={styles.articleHeader}>
                        ...
                        <div className={styles.heroImage}>
                            <Image
                                src="https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=1280&h=720&fit=crop"
                                alt="best ugc video creation service for real estate marketing dashboard interface"
                                width={1280}
                                height={720}
                                priority
                            />
                    ...
                    <section id="what-is" className={styles.section}>
                        ...
                        <div className={styles.imageWrapper}>
                            <Image
                                src="https://images.unsplash.com/photo-1556761175-b413da4baf72?w=1280&h=720&fit=crop"
                                alt="real estate agent using laptop showing property listings"
                                width={1280}
                                height={720}
                            />
                        </div>
                    ...
                    <section id="guide" className={styles.section}>
                        ...
                        <div className={styles.imageWrapper}>
                            <Image
                                src="https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=1280&h=720&fit=crop"
                    ...
                    <section id="legal" className={styles.section}>
                        ...
                        <div className={styles.imageWrapper}>
                            <Image
                                src="https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=1280&h=720&fit=crop"
                                alt="legal scales representing real estate law"
                                width={1280}
                                height={720}
                            />
                        </div>
