...
export const metadata: Metadata = {
    title: 'Melhores Plataformas IA para Criar Vídeos UGC de Marca (2025) | AdMaker AI',
    alternates: {
        canonical: 'https://admakerai.app/pt/blog/melhores-plataformas-ia-criar-videos-ugc-marca',
        languages: {
