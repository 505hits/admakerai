...
export const metadata: Metadata = {
    title: 'Melhores Criadores de Vídeo UGC para Anúncios Sociais (2025) | AdMaker AI',
    alternates: {
        canonical: 'https://admakerai.app/pt/blog/melhores-criadores-video-ugc-para-anuncios-sociais',
        languages: {
