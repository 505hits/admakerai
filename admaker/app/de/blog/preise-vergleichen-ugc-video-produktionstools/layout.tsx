...
export const metadata: Metadata = {
    title: 'Preise vergleichen für UGC-Video-Produktionstools (2025) | AdMaker AI',
    alternates: {
        canonical: 'https://admakerai.app/de/blog/preise-vergleichen-ugc-video-produktionstools',
        languages: {
