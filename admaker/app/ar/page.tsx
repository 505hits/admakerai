                ...
                <div className="container">
                    <div className="feature-row">
                        <div className="feature-content">
                            <h3>احصل على فيديوهات الذكاء الاصطناعي المثالية لـ <TypedText /></h3>
                            <p>أنشئ إعلانات فيديو احترافية في أقل من دقيقتين. يحول الذكاء الاصطناعي المتقدم لدينا نصك إلى محتوى فيروسي فوري.</p>
                            <ul className="feature-list">
                                <li>✓ أكثر من 300 نموذج ممثل متاح</li>
                                <li>✓ إنشاء فيديوهات في أقل من دقيقتين</li>
                                <li>✓ تحسين النص بالذكاء الاصطناعي</li>
                                <li>✓ إنشاء فوري للمحتوى الفيروسي</li>
                            </ul>
                        </div>
                        <div className="feature-image feature-image-tilt">
                            <img src={getMediaUrl('ultra-fast-generation.jpg')} alt="أمثلة فيديوهات UGC" />
                        </div>
                    </div>

                    {/* Step by Step Guide */}
                    <div className="section-header" style={{ marginTop: '80px' }}>
                        <h2>كيفية إنشاء فيديوهات UGC بالذكاء الاصطناعي في <span className="gradient-text-red">3 خطوات بسيطة</span></h2>
                        <p>يسهل منشئ الفيديو بالذكاء الاصطناعي من النص إنشاء إعلانات فيديو UGC احترافية في دقائق.</p>
                    </div>
                    ...
                    <div className="steps-container" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '30px', marginTop: '50px' }}>
                        ...
                        <div className="step-card animate-fade-in-up stagger-1" style={{ background: 'rgba(255, 255, 255, 0.03)', borderRadius: '20px', padding: '30px', border: '1px solid rgba(255, 255, 255, 0.1)', transition: 'transform 0.3s ease, box-shadow 0.3s ease' }} onMouseEnter={(e) => { e.currentTarget.style.transform = 'translateY(-8px)'; e.currentTarget.style.boxShadow = '0 12px 40px rgba(255, 8, 68, 0.2)'; }} onMouseLeave={(e) => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = 'none'; }}>
                            ...
                            <h3 style={{ fontSize: '24px', marginBottom: '12px', color: '#fff', fontWeight: '600' }}>اختر ممثلاً</h3>
                            <p style={{ color: 'rgba(255, 255, 255, 0.7)', lineHeight: '1.6', marginBottom: '24px', fontSize: '15px' }}>استخدم مكتبتنا، أو قم بتحميل صورة، أو استخدم مولد الصور بالذكاء الاصطناعي الواقعي.</p>
                            <div style={{ background: 'rgba(255, 255, 255, 0.05)', borderRadius: '12px', padding: '20px', border: '1px solid rgba(255, 255, 255, 0.08)' }}>
                                <img src={getMediaUrl('step1.jpg')} alt="اختيار ممثل ذكاء اصطناعي" style={{ width: '100%', borderRadius: '8px' }} />
                            </div>
                        </div>
                        ...
                        <div className="step-card animate-fade-in-up stagger-2" style={{ background: 'rgba(255, 255, 255, 0.03)', borderRadius: '20px', padding: '30px', border: '1px solid rgba(255, 255, 255, 0.1)', transition: 'transform 0.3s ease, box-shadow 0.3s ease' }} onMouseEnter={(e) => { e.currentTarget.style.transform = 'translateY(-8px)'; e.currentTarget.style.boxShadow = '0 12px 40px rgba(255, 107, 107, 0.2)'; }} onMouseLeave={(e) => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = 'none'; }}>
                            ...
                            <h3 style={{ fontSize: '24px', marginBottom: '12px', color: '#fff', fontWeight: '600' }}>اكتب النص</h3>
                            <p style={{ color: 'rgba(255, 255, 255, 0.7)', lineHeight: '1.6', marginBottom: '24px', fontSize: '15px' }}>حول أفكارك إلى إعلانات جاهزة للتصوير مع الكتابة الذكية بالذكاء الاصطناعي.</p>
                            <div style={{ background: 'rgba(255, 255, 255, 0.05)', borderRadius: '12px', padding: '20px', border: '1px solid rgba(255, 255, 255, 0.08)' }}>
                                <img src={getMediaUrl('Step2.png')} alt="كتابة النص" style={{ width: '100%', borderRadius: '8px' }} />
                            </div>
                        </div>
                        ...
                        <div className="step-card animate-fade-in-up stagger-3" style={{ background: 'rgba(255, 255, 255, 0.03)', borderRadius: '20px', padding: '30px', border: '1px solid rgba(255, 255, 255, 0.1)', transition: 'transform 0.3s ease, box-shadow 0.3s ease' }} onMouseEnter={(e) => { e.currentTarget.style.transform = 'translateY(-8px)'; e.currentTarget.style.boxShadow = '0 12px 40px rgba(255, 26, 90, 0.2)'; }} onMouseLeave={(e) => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = 'none'; }}>
                            ...
                            <h3 style={{ fontSize: '24px', marginBottom: '12px', color: '#fff', fontWeight: '600' }}>أنشئ الفيديو</h3>
                            <p style={{ color: 'rgba(255, 255, 255, 0.7)', lineHeight: '1.6', marginBottom: '24px', fontSize: '15px' }}>اجعل كل شيء ينبض بالحياة مع UGC مذهل وواقعي في دقائق.</p>
                            <div style={{ background: 'rgba(255, 255, 255, 0.05)', borderRadius: '12px', padding: '20px', border: '1px solid rgba(255, 255, 255, 0.08)' }}>
                                <img src={getMediaUrl('step3.jpg')} alt="إنشاء الفيديو" style={{ width: '100%', borderRadius: '8px' }} />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="container">
                    <div className="section-header animate-fade-in-up" style={{ textAlign: 'center', marginBottom: '60px' }}>
                        ...
                        <h2 style={{ fontSize: 'clamp(36px, 5vw, 56px)', fontWeight: '800', marginBottom: '20px', lineHeight: '1.2' }}>
                            مُكرر <span className="gradient-text-red">الإعلانات الرابحة</span>
                        </h2>
                        <p style={{ fontSize: '18px', color: 'rgba(255, 255, 255, 0.7)', maxWidth: '800px', margin: '0 auto', lineHeight: '1.6' }}>
                            قم بتحميل أي إعلان رابح وكرره مع ممثل ذكاء اصطناعي مختلف. مثالي لاختبار وجوه جديدة مع الحفاظ على نفس النص والأسلوب المثبت.
                        </p>
                    </div>
                    ...
                    <div className="animate-fade-in-up stagger-1" style={{
                        ...
                        <div style={{
                            ...
                            <h3 style={{ fontSize: '18px', fontWeight: '700', color: '#fff', marginBottom: '8px' }}>
                                نسخة جديدة مع ممثل ذكاء اصطناعي
                            </h3>
                            <p style={{ fontSize: '14px', color: 'rgba(255, 255, 255, 0.6)', lineHeight: '1.5' }}>
                                نفس النص، وجه مختلف، نتائج فورية
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="container">
                    <div className="section-header">
                        <h2 style={{ fontSize: '48px', marginBottom: '20px' }}>
                            إنشاء فيديوهات UGC بالذكاء الاصطناعي لم يكن أسهل من ذلك
                        </h2>
                    </div>
                    ...
                    <div style={{
                        ...
                        <div className="animate-scale-in stagger-1" style={{
                            ...
                            <h3 style={{ fontSize: '18px', fontWeight: '600', color: '#fff', marginBottom: '12px' }}>
                                إنشاء فيديوهات YouTube Shorts
                            </h3>
                            <p style={{ fontSize: '14px', color: 'rgba(255, 255, 255, 0.7)', lineHeight: '1.6', margin: 0 }}>
                                أنشئ فيديوهات YouTube Shorts بمحتوى مُنشأ بالذكاء الاصطناعي. لا حاجة لتسجيل أي شيء.
                            </p>
                        </div>
                        ...
                        <div className="animate-scale-in stagger-2" style={{
                            ...
                            <h3 style={{ fontSize: '18px', fontWeight: '600', color: '#fff', marginBottom: '12px' }}>
                                إنشاء فيديوهات TikTok فيروسية
                            </h3>
                            <p style={{ fontSize: '14px', color: 'rgba(255, 255, 255, 0.7)', lineHeight: '1.6', margin: 0 }}>
                                أنشئ فيديوهات TikTok التي تصبح فيروسية. لا حاجة للرقص أو مزامنة الشفاه.
                            </p>
                        </div>
                        ...
                        <div className="animate-scale-in stagger-3" style={{
                            ...
                            <h3 style={{ fontSize: '18px', fontWeight: '600', color: '#fff', marginBottom: '12px' }}>
                                النشر على TikTok و YouTube
                            </h3>
                            <p style={{ fontSize: '14px', color: 'rgba(255, 255, 255, 0.7)', lineHeight: '1.6', margin: 0 }}>
                                انشر فيديوهاتك مباشرة من التطبيق.
                            </p>
                        </div>
                        ...
                        <div className="animate-scale-in stagger-4" style={{
                            ...
                            <h3 style={{ fontSize: '18px', fontWeight: '600', color: '#fff', marginBottom: '12px' }}>
                                100% مدعوم بالذكاء الاصطناعي
                            </h3>
                            <p style={{ fontSize: '14px', color: 'rgba(255, 255, 255, 0.7)', lineHeight: '1.6', margin: 0 }}>
                                نستخدم أحدث وأقوى النماذج لإنشاء محتوى ذي صلة وجذاب.
                            </p>
                        </div>
                        ...
                        <div className="animate-scale-in stagger-5" style={{
                            ...
                            <h3 style={{ fontSize: '18px', fontWeight: '600', color: '#fff', marginBottom: '12px' }}>
                                تعليقات صوتية بالذكاء الاصطناعي
                            </h3>
                            <p style={{ fontSize: '14px', color: 'rgba(255, 255, 255, 0.7)', lineHeight: '1.6', margin: 0 }}>
                                نستخدم أحدث نماذج الذكاء الاصطناعي لإنشاء تعليقات صوتية لفيديوهاتك.
                            </p>
                        </div>
                        ...
                        <div className="animate-scale-in stagger-6" style={{
                            ...
                            <p style={{ fontSize: '14px', color: 'rgba(255, 255, 255, 0.7)', lineHeight: '1.6', margin: 0 }}>
                                أضف موسيقى خلفية لفيديوهاتك. لدينا مكتبة تضم آلاف الأغاني.
                            </p>
                        </div>
                        ...
                        <div className="animate-scale-in stagger-7" style={{
                            ...
                            <p style={{ fontSize: '14px', color: 'rgba(255, 255, 255, 0.7)', lineHeight: '1.6', margin: 0 }}>
                                صدّر بتنسيق 9:16 أو 1:1 أو 16:9 لـ TikTok و Instagram Reels و YouTube.
                            </p>
                        </div>
                        ...
                        <div className="animate-scale-in stagger-8" style={{
                            ...
                            <p style={{ fontSize: '14px', color: 'rgba(255, 255, 255, 0.7)', lineHeight: '1.6', margin: 0 }}>
                                AdMaker AI يتطور باستمرار. نضيف ميزات جديدة كل أسبوع.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="container">
                    <div style={{
                        ...
                        <p style={{
                            ...
                            ابدأ مع AdMaker AI اليوم وأنشئ فيديوهات UGC جذابة لـ TikTok و Instagram Reels و YouTube بشكل تلقائي.
                        </p>
                        <a
                            href="/ar/login"
                ...
                <div className="container">
                    <div className="footer-content">
                        <div className="footer-brand">
                            ...
                            <p>المنصة رقم 1 لإنشاء إعلانات فيديو بالذكاء الاصطناعي في دقائق.</p>
                        </div>
                    </div>
                    <div className="footer-bottom">
                        <p>© 2024 AdMaker AI. جميع الحقوق محفوظة.</p>
                    </div>
                </div>
            </footer>
        </main>
