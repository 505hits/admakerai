...
export const metadata = {
    title: 'Terms of Service | AdMaker AI',
    description: 'Terms of Service for AdMaker AI - AI-powered UGC video creation platform',
};
            ...
            <div className={styles.legalContainer}>
                <div className="container">
                    <div className={styles.legalContent}>
                        ...
                        <section>
                            <h2>1. Nature of Services and Legal Disclaimer</h2>
                            <p>
                        ...
                        <section>
                            <h2>2. Licensing and Subscription Requirements</h2>
                            <p>
                        ...
                        <section>
                            <h2>5. Ethical Use of AI, Likeness Rights, and Platform Compliance</h2>
                            <p>
                        ...
                        <section>
                            <h2>6. Billing, Payments, and Subscription Terms</h2>
                            <p>
                        ...
                        <section>
                            <h2>7. Service Availability and Termination</h2>
                            <p>
                        ...
                        <section>
                            ...
                            <p>
                                If you believe your intellectual property has been infringed by content generated using AdMaker AI, you may submit a notice to <a href="mailto:contact.admakerai@gmail.com">contact.admakerai@gmail.com</a> including:
                            </p>
                            <ul>
