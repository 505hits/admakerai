...
export const metadata: Metadata = {
    title: 'Mejores Plataformas IA para Crear Videos UGC de Marca (2025) | AdMaker AI',
    alternates: {
        canonical: 'https://admakerai.app/es/blog/mejores-plataformas-ia-crear-videos-ugc-marca',
        languages: {
