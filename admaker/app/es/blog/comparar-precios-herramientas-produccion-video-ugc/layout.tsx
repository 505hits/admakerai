...
export const metadata: Metadata = {
    title: 'Comparar Precios de Herramientas de Producción de Video UGC (2025) | AdMaker AI',
    alternates: {
        canonical: 'https://admakerai.app/es/blog/comparar-precios-herramientas-produccion-video-ugc',
        languages: {
