                ...
                <div className={styles.modalBody}>
                    ...
                    <div className={styles.offerSection}>
                        <div className={styles.countdown}>
                            <div className={styles.countdownLabel}>⏰ Oferta limitada expira en</div>
                        ...
                        <p className={styles.subtitle}>
                            Has alcanzado tu límite gratuito. Actualiza a Pro para generar ganchos ilimitados y crear videos que convierten.
                        </p>
                        ...
                        <div className={styles.features}>
                            <div className={styles.feature}>
                                ...
                                <span>Generaciones de ganchos ilimitadas</span>
                            </div>
                            <div className={styles.feature}>
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                                    <path d="M20 6L9 17L4 12" stroke="#00ff88" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                </svg>
                                <span>Creación de video con actores IA</span>
                            </div>
                            <div className={styles.feature}>
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                                    <path d="M20 6L9 17L4 12" stroke="#00ff88" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                </svg>
                                <span>Exportaciones HD ilimitadas</span>
                            </div>
                            <div className={styles.feature}>
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                                    <path d="M20 6L9 17L4 12" stroke="#00ff88" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                        ...
                        <div className={styles.guarantee}>
                            ...
                            <span>Garantía de devolución de dinero de 30 días • Cancela en cualquier momento</span>
                        </div>
                    </div>
                </div>
            </div>
