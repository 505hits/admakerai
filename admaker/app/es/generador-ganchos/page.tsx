...
export default function GeneradorGanchos() {
    ...
    const handleGenerate = async () => {
        if (!videoIdea.trim()) {
            setError('Por favor, ingresa tu idea de video');
            return;
        }
        ...
        try {
            ...
            if (!response.ok) {
                if (data.limitReached) {
                    ...
                    throw new Error(data.error || 'Error al generar ganchos');
                }
                return;
            }
            ...
            setError(err instanceof Error ? err.message : 'Error al generar ganchos. Por favor, inténtalo de nuevo.');
        } finally {
    ...
    return (
        <main>
                ...
                <div className="container">
                    <div className={styles.heroContent}>
                        ...
                        <h1 className={styles.title}>
                            <span className="gradient-text-red">Generador de Ganchos</span> IA Gratis
                        </h1>
                        <p className={styles.subtitle}>
                            Crea 3 ganchos de video virales en segundos. Perfecto para TikTok, Instagram Reels y YouTube Shorts.
                        </p>
                        ...
                        {isAuthenticated && hooksRemaining !== null && hooksRemaining >= 0 && !isPaidUser && (
                            <div className={styles.hooksCounter}>
                                ...
                                {hooksRemaining} generaciones gratuitas restantes
                            </div>
                        )}
                        ...
                        <div className={styles.inputContainer}>
                            ...
                            <textarea
                                ...
                                placeholder="Ejemplo: Una aplicación de productividad que te ayuda a concentrarte bloqueando sitios web que distraen"
                                value={videoIdea}
                ...
                <div className="container">
                    ...
                    {hooks.length > 0 && (
                        <div ref={resultsRef} className={styles.resultsContainer}>
                            <h2 className={styles.resultsTitle}>Tus Ganchos Virales</h2>
                                ...
                                {hooks.map((hook, index) => (
                                    <div key={index} className={styles.hookCard}>
                                        ...
                                        <div className={styles.hookActions}>
                                            ...
                                            <a href={isPaidUser ? "/dashboard" : "/es"} className={styles.generateVideoBtn}>
                                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                ...
                <div className="container">
                    ...
                    <div className={styles.stepsGrid}>
                        <div className={styles.step}>
                            ...
                            <h3>Describe tu Video</h3>
                            <p>Cuéntanos de qué trata tu video en pocas palabras</p>
                        </div>
                        <div className={styles.step}>
                            <div className={styles.stepNumber}>2</div>
                            <h3>La IA Genera Ganchos</h3>
                            <p>Nuestra IA crea 3 ganchos únicos y llamativos</p>
                        </div>
                        <div className={styles.step}>
                            <div className={styles.stepNumber}>3</div>
                            <h3>Copia y Usa</h3>
                            <p>Elige tu favorito y úsalo en tu video</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className={styles.examples}>
                <div className="container">
                    <div className="section-header">
                        <h2>Ejemplos de Ganchos</h2>
                    </div>
                    <div className={styles.examplesGrid}>
                        <div className={styles.exampleCard}>
                            <p className={styles.exampleHook}>"Espera... esto cambió todo sobre cómo edito videos"</p>
                            <span className={styles.exampleType}>Interrupción de Patrón</span>
                        </div>
                        <div className={styles.exampleCard}>
                            <p className={styles.exampleHook}>"Nadie habla de esto, pero el 90% de los videos virales usan este truco"</p>
                            <span className={styles.exampleType}>Brecha de Curiosidad</span>
                        </div>
                        <div className={styles.exampleCard}>
                            <p className={styles.exampleHook}>"Intenté publicar a las 3 AM durante 30 días y..."</p>
                ...
                <section className={styles.cta}>
                    <div className="container">
                        <div className={styles.ctaContent}>
                            <h2>¿Quieres Generaciones Ilimitadas?</h2>
                            <p>Regístrate para obtener 10 generaciones gratuitas, luego actualiza para acceso ilimitado</p>
                            <button className="btn-primary btn-large" onClick={() => router.push('/es/iniciar-sesion')}>
                                Comenzar Gratis
                            </button>
                        </div>
                    </div>
