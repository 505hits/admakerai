    ...
    return (
        <>
            ...
            <div className={styles.pageContainer}>
                <div className={styles.contentWrapper}>
                    <article className={styles.articleContent}>
                        <header className={styles.articleHeader}>
                            <h1 className={styles.mainTitle}>Comparatif des Tarifs des Outils de Production Vidéo UGC</h1>
                            <div className={styles.heroImage}>
                                <Image src=\""https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=1280&h=720&fit=crop\"" alt=\""graphiques de comparaison de prix et calculatrice sur un bureau\"" width={1280} height={720} priority />
                            </div>
                        </header>
                ...
                <a href={landingPageUrl} className={${styles.stickyCta} } aria-label=\""Comparer les tarifs\"">
                    Comparer Maintenant
                </a>
            </div>
        </>
