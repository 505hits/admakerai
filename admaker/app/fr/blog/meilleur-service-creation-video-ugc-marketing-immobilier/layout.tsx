...
export const metadata: Metadata = {
    title: 'Meilleur Service de Création Vidéo UGC pour le Marketing Immobilier (2025) | AdMaker AI',
    description: 'Découvrez le meilleur service de création de vidéos UGC pour le marketing immobilier.',
    alternates: {
    ...
    openGraph: {
        type: 'article',
        title: 'Meilleur Service de Création Vidéo UGC pour le Marketing Immobilier',
        url: 'https://admakerai.app/fr/blog/meilleur-service-creation-video-ugc-marketing-immobilier',
        siteName: 'AdMaker AI',
        locale: 'fr_FR',
    },
};
