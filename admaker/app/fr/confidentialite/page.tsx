...
export const metadata = {
    title: 'Politique de confidentialité | AdMaker AI',
    description: 'Politique de confidentialité pour AdMaker AI - Comment nous collectons, utilisons et protégeons vos données',
};
