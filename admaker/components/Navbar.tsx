...
export default function Navbar({ lang = 'en' }: NavbarProps) {
    ...
    const getLanguageUrl = (targetLang: 'en' | 'fr' | 'es' | 'pt' | 'ko' | 'de' | 'ja') => {
        ...
        const pathMappings: { [key: string]: { [key: string]: string } } = {
            ...
            '/hook-generator': { en: '/hook-generator', fr: '/fr/generateur-accroches', es: '/es/generador-ganchos', pt: '/pt/gerador-ganchos', ko: '/ko/hook-generator', de: '/de/hook-generator', ja: '/ja/hook-generator' },
            '/generateur-accroches': { en: '/hook-generator', fr: '/fr/generateur-accroches', es: '/es/generador-ganchos', pt: '/pt/gerador-ganchos', ko: '/ko/hook-generator', de: '/de/hook-generator', ja: '/ja/hook-generator' },
            '/generador-ganchos': { en: '/hook-generator', fr: '/fr/generateur-accroches', es: '/es/generador-ganchos', pt: '/pt/gerador-ganchos', ko: '/ko/hook-generator', de: '/de/hook-generator', ja: '/ja/hook-generator' },
            '/gerador-ganchos': { en: '/hook-generator', fr: '/fr/generateur-accroches', es: '/es/generador-ganchos', pt: '/pt/gerador-ganchos', ko: '/ko/hook-generator', de: '/de/hook-generator', ja: '/ja/hook-generator' },
            ...
            <div className="container">
                <div className={styles.navContent}>
                    ...
                    <div className={`${styles.navLinks} ${isMobileMenuOpen ? styles.active : ''}`}>
                        ...
                        <a href={lang === 'fr' ? '/fr/generateur-accroches' : lang === 'es' ? '/es/generador-ganchos' : lang === 'pt' ? '/pt/gerador-ganchos' : '/hook-generator'}>{t.hookGenerator}</a>
